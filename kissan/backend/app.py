...
from backend.crop_recc.api import crop_bp
...
app.register_blueprint(crop_bp, url_prefix="/crop_recc")


# ✅ Optional Root Route
@app.route("/")
def home():
    return {"message": "All APIs (Chatbot, Weather, News, PriceModel, crop) are running!"}
